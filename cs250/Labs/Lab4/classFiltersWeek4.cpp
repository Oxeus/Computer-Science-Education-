...
void display() {
	...
	while(curr)
	{
		cout << " Picture Changer: " << endl;
		cout << " 1. Change colors (light change) " << endl <<
			" 2. Change colors (full change) " << endl <<
			" 3. Change contrast " << endl << 
			" 4. Change brightness " << endl <<
			" 5. Change blur " << endl <<
			" 6. Exit Menu and Save Image. " << endl;
		...
		switch(choice)
		{
			case 1:
				int red, blue, green;
				cout << "Please choose color values: " << endl;
				cout << "R: B: G ";
				cin >> red;
				cin >> blue;
				cin >> green;
				reColor(arr, red, blue, green);
				break;
			case 6:
				curr = false;
				break;
