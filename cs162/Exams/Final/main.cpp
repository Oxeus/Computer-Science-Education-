 ...
 * the list.  It will find the first even number in the list
 *  and remove the node from the list. Remember to
 *  delete the node after removing it from the list.
 *  If there are no even numbers in the list the function
...
void deleteFirstEven(Node *head, Node  *tail)
{
	Node* current = head;
	Node* prev = NULL;
	while (current)
...
//  END OF FUNCTION - DO NOT REMOVE THIS COMMENT LINE.
